...
from src.models import image_models as pretrained_models
from src.models.model import model_architectures as architectures
...
def inference(model, x):
    ...
    bpp = total_length * 8.0 / num_pixels
