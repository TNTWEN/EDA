...
from src.models.chen2020 import (
    Cheng2020Anchor,
    Cheng2020Attention,
)

from src.models.entroformer import Entroformer
from src.models.entroformerdebug import Entroformerdebug
from src.models.DATEntroformer import DATEntroformer
from src.models.DATEntroformerv1 import DATEntroformerv1
from src.models.DATEntroformerv2 import DATEntroformerv2
__all__ = [
...
def entroformer(quality, **kwargs):


    if quality < 1 or quality > 8:
        raise ValueError(f'Invalid quality "{quality}", should be between (1, 8)')

    return _load_custom_model(
        "entroformer", quality, **kwargs
    )


def entroformerdebug(quality, **kwargs):
    ...
    return _load_custom_model(
        "entroformerdebug", quality, **kwargs
    )

def datentroformer(quality, **kwargs):
    ...
    return _load_custom_model(
        "datentroformer", quality, **kwargs
    )

def datentroformerv1(quality, **kwargs):
    ...
    return _load_custom_model(
        "datentroformerv1", quality, **kwargs
    )

def datentroformerv2(quality, **kwargs):
    ...
    return _load_custom_model(
        "datentroformerv2", quality, **kwargs
    )
